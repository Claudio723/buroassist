    ...
    <section id="leistungen" className="max-w-7xl mx-auto px-6 py-24 md:py-32">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="md:col-span-2 lg:col-span-3 service-card group glass rounded-3xl p-10 md:p-12 flex flex-col md:flex-row gap-8 md:gap-12 border border-white/60 bg-primary/[0.03]"
        >
          <div className="flex-shrink-0">
            <div className="w-20 h-20 rounded-2xl bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors">
              <FeaturedIcon className="w-11 h-11 text-primary" />
            </div>
          </div>
          <div className="flex-grow flex flex-col">
            <h3 className="text-3xl md:text-4xl font-semibold tracking-tight mb-4">{featuredService.title}</h3>
            <p className="text-text-muted leading-relaxed text-lg max-w-2xl">{featuredService.desc}</p>
