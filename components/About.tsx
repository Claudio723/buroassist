      ...
      <div className="grid md:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <div className="space-y-7 text-xl text-text-muted leading-relaxed">
            <p>
              Zu viel Papierkram, zu wenig Zeit? Ich unterstütze kleine Unternehmen bei administrativen Aufgaben – pragmatisch und mit Freude an klarer Organisation.
            </p>
            <p>
              Keine Agentur, kein Callcenter. Einfach persönliche Hilfe für Firmen in der ganzen Schweiz – unkompliziert und zuverlässig.
            </p>
          </div>
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center text-white">
              ...
              <div className="text-white/70 mt-1">Gründerin</div>
            </div>
          </div>
